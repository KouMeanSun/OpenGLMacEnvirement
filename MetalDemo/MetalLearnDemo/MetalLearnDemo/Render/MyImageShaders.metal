...
vertexShader(uint vertexID [[vertex_id]],
             ...
             constant vector_int2 *viewportSizePointer [[buffer(CCVertexInputIndexViewportSize)]]){
    /*
     处理顶点数据:
    ...
    //将viewportSizePointer 从vector_int2 转换为vector_float2 类型
